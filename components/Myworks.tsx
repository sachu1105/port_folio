...
const projects = [
  ...
  },
  {
    ...
    title: "Robot Website",
    year: "[2023]",
    image: "/futuristic-robot-website.png",
  ...
  },
  {
    ...
    year: "[2024]",
    image: "/video-chat-interface.png",
  ...
  },
  {
    ...
    title: "Image Editor",
    year: "[2023]",
    image: "/image-editor-interface.png",
  ...
  },
  {
    ...
    year: "[2024]",
    image: "/certificate-generator-interface.png",
        ...
        <div className="w-1/2 bg-black flex flex-col justify-center pl-12 pr-8">
          ...
          <div className="space-y-1">
            {projects.map((project, index) => (
              ...
              >
                <h3
                  className={`text-4xl md:text-5xl lg:text-6xl font-medium leading-tight transition-all duration-500 ${
